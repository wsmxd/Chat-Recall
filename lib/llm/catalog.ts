...
export const providerCatalog: ProviderCatalogItem[] = [
  ...
  { id: "glm", name: "GLM (Zhipu)", models: ["glm-4.6", "glm-4.5", "glm-4-plus", "glm-4-flash", "glm-4-air"], defaultModel: "glm-4-flash" },
  { id: "minimax", name: "MiniMax", models: ["MiniMax-M2.7", "MiniMax-M1", "MiniMax-Text-01"], defaultModel: "MiniMax-M1" }
];
